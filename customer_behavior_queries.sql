...
--Q5.Do subscibed customers spend more? compare average spend and total revenue between subscribes and nom-subscribe.
...
--Q6.Which 5 products have the highest percentages with discounts applied?
...
--purchases and shoe the count of each segment.
...
--Q8.What are the top 3most purchased products within each category?
with item_counts as(
select category,
item_purchased,
